...
Route::get('/testar-fedex', function() {
    ...
    $httpCode = null;
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, config('services.fedex.auth_url'));
    curl_setopt($ch, CURLOPT_POST, 1);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query([
        'grant_type' => 'client_credentials',
        'client_id' => config('services.fedex.key'),
        'client_secret' => config('services.fedex.password')
    ]));
    ...
    if ($accessToken) {
        ...
        curl_setopt($ch, CURLOPT_URL, config('services.fedex.rate_url'));
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
