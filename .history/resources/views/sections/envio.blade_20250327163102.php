...
<script>
    $(document).ready(function() {
        ...
        function carregarCidades(estadoId, cidadeSelect) {
            ...
            cidadeSelect.prop('disabled', estadoCidades.length === 0);
                    ...
                    if (paisBrasil) {
                        ...
                        setTimeout(function() {
                            ...
                            if (estado) {
                                ...
                                setTimeout(function() {
                                    // Inserir a cidade se não estiver na lista
                                    let cidadeOption = $(`#${prefixo}_cidade option`).filter(function() {
                                        return $(this).text().toLowerCase() === data.localidade.toLowerCase();
                                    });
