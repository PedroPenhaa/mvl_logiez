    ...
    <script>
        $(document).ready(function() {
            ...
            function loadSection(section) {
                ...
                $('#main-content').html('<div class="d-flex justify-content-center my-5"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Carregando...</span></div></div>');
