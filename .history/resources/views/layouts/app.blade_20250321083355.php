...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.menu-item[data-section]').click(function() {
                ...
                $('#section-title').text($(this).find('.menu-text').text());
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Inicializar componentes e eventos específicos da seção
                        initializeSection(section);
                    },
                    error: function() {
                        showAlert('Erro ao carregar a seção. Por favor, tente novamente.', 'danger');
                    },
                    complete: function() {
                        // Esconder loader
                        $('#content-loader').hide();
            ...
            function initializeSection(section) {
                switch(section) {
                    ...
                    case 'perfil':
                        initPerfilSection();
                        break;
                    // Adicione outras inicializações específicas conforme necessário
                }
            }
